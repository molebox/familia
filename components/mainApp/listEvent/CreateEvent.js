...
const validationSchema = yup.object().shape({
  ...
  date: yup
    .date()
    .min(new Date())
    .max(new Date(oneYearFromNow), "The date must be within a year")
            ...
            <View>
              ...
              <View style={styles.inputContainer}>
                ...
                {!!errors.eventTitle && !!touched.eventTitle ? (
                  <View style={styles.error}>
                    <ErrorsAndWarnings error={errors.eventTitle} />
                  </View>
                ) : null}
              </View>
              <View>
                ...
                {!!errors.date && !!touched.date ? (
                  <View style={styles.error}>
                    <ErrorsAndWarnings error={errors.date} />
                  </View>
                ) : null}
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                {!!errors.organiser && !!touched.organiser ? (
                  <View style={styles.error}>
                    <ErrorsAndWarnings error={errors.organiser} />
                  </View>
                ) : null}
              </View>
              <View style={styles.inputContainer}>
                ...
                {!!errors.email && !!touched.email ? (
                  <View style={styles.error}>
                    <ErrorsAndWarnings error={errors.email} />
                  </View>
                ) : null}
              </View>
              <View>
                ...
                >
                  <View style={styles.inputContainer}>
                    ...
                    {!!errors.description && touched.description ? (
                      <View style={styles.error}>
                        <ErrorsAndWarnings error={errors.description} />
                      </View>
                    ) : null}
                  </View>
                </TouchableOpacity>
                  ...
                  <View style={styles.textAreaContainer}>
                    ...
                    <View style={styles.counterContainer}>
                      <Text style={styles.counter}>
                        {values.description.split(" ").length}/100
                      </Text>
                    </View>
                  </View>
                </Modal>
              ...
              <View style={styles.inputContainer}>
                <TextInput
                  style={styles.fieldText}
                  placeholder="LOCATION - nearest city"
                  placeholderTextColor="#81e6fc"
                ...
                {!!errors.location && !!touched.location ? (
                  <View style={styles.error}>
                    <ErrorsAndWarnings error={errors.location} />
                  </View>
                ) : null}
              </View>
              <View style={styles.inputContainer}>
                ...
                {!!errors.link && !!touched.link ? (
                  <View style={styles.error}>
                    <ErrorsAndWarnings error={errors.link} />
                  </View>
                ) : null}
              </View>
              {!!isSubmitting ? (
              ...
              <View style={styles.submitButton}>
                <Button
                  ...
                  onPress={() => handleReset(initialValues)}
                  text="RESET"
                />
              </View>
            </View>
